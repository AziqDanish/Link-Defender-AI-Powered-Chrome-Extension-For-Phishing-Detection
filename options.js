document.addEventListener('DOMContentLoaded', async () => {
  // Credentials live in storage.sync — tied to the Chrome/Google login, not
  // the machine. Sign into Chrome with sync on, on a new laptop, and these
  // fields pre-fill automatically.
...
// Sends a trivial one-off request directly to Gemini to confirm the key
// works. This is a manual settings action, not part of scanning — it never
// runs automatically and doesn't touch the "Why?" cache.
...
// Useful if a site's status has changed and you want fresh results rather
// than waiting out the 24h cache window.
function clearCache() {
